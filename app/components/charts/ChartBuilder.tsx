...
export const ChartBuilder: React.FC<ChartBuilderProps> = ({
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div>
        <label className="mb-3 block text-sm font-medium text-gray-700">Chart Type</label>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700">Chart Title</label>
            <input
              type="text"
              value={config.title}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700">Y-Axis</label>
            <select
              value={config.yAxis || ''}
                ...
                >
                  <div className="mb-1 flex space-x-1">
                    {colors.slice(0, 4).map((color, index) => (
                      <div key={index} className="size-3 rounded-sm" style={{ backgroundColor: color }}></div>
                    ))}
                  </div>
      ...
      <div>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4">
          {generateChartData ? (
            <div className="max-h-96 max-w-full">{renderChart()}</div>
          ) : (
            <div className="flex h-64 items-center justify-center text-gray-400">
              <div className="text-center">
                <svg className="mx-auto mb-2 size-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"
